...
public class userServiceController {
	 ...
	 * public String gotoCourses( ModelMap map,User user,HttpServletRequest
	 * request,HttpSession session,@RequestParam int cid) { User u = (User)
	 * session.getAttribute("user_s"); System.out.println(user); List<courseContent>
	 * temp = (List<courseContent>) contentserv.getContentList(cid);
	 * System.out.println(temp); request.setAttribute("cnid",
	 * temp.get(0).getContentId()); System.out.println(temp.get(0).getContentId());
	 * 
	 * map.put("cntList", temp); map.put("u", u); Courses c =
	 * courseServ.getByCourseId(cid); map.put("course",c);
	 * 
	 * 
	 * return "goToCourse"; }
	 */
