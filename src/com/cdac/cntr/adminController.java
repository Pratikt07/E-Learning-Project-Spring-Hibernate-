...
public class adminController {
	...
	public String  logAdminForm(Admin admin, ModelMap map,HttpServletRequest request, HttpSession session) {
		...
		return "adminLoginSuccess";
			...
			request.setAttribute("msg", "No Account Found, Please Try Again.");
