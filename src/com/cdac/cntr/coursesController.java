...
public class coursesController {
	...
	public String addCourse(Courses course, ModelMap map,HttpSession s,HttpServletRequest request) {
		/*
		 * List<Courses> li = courseServ.showAllCourses(); for(Courses crs : li) {
		 * if(crs.getCourseName()==course.et) }
		 */
