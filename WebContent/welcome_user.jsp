...
<div class="container  " style="height: 100% ">
	<% User user1 = (User) session.getAttribute("user_s");
		System.out.print(user1);
	%>
	<div class=" row " style="margin-top: 15vh">
			<h4  style="font-family:  'Indie Flower', cursive">Welcome <%= user.getUserName() %></h4>
	...
	<div class="row">
		...
		<div class="col-6 d-flex align-items-center  rounded-sm">
					<img class="img-fluid" alt="temp" src="Source/4.jpg" style="width:60vw ">
		</div>
	</div>
