		...
		<div class="row justify-content-center align-items-center" style="height: 100vh">
			<div class="col-8  d-flex  justify-content-center " >
				...
				<div class="col-6 d-flex align-items-center border border-dark shadow rounded-sm">
					<img class="img-fluid" alt="temp" src="Source/1.jpg" style="width:60vw ">
				</div>
				<div class="col-6 border border-dark bg-light shadow rounded-sm" style="height: 90%">
					...
					<spr:form class ="form was-validated "  action="reg_user_form.htm"  method="post" commandName="user" >
					    ...
					    <input required="required" pattern="^[a-zA-Z ]*$" minlength="3" maxlength="20" type="text" class="form-control is-valid" id="exampleInputText1" style="height: 7vh" name="userName">
					  </div>
					  <div class="">
					    <label style="font-size:3.5vh " for="exampleInputText1">User Name</label>
					    <input required="required" minlength="3" maxlength="10" type="text" class="form-control is-valid" id="exampleInputText1" style="height: 7vh" name="userUserName">
					  </div>
					  <div class="">
